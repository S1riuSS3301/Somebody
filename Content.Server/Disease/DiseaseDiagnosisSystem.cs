...
namespace Content.Server.Disease
{
    ...
    public sealed partial class DiseaseDiagnosisSystem : EntitySystem
    {
        ...
        private void OnAfterInteractUsing(EntityUid uid, DiseaseDiagnoserComponent component, AfterInteractUsingEvent args)
        {
            ...
            if (args.Handled || !args.CanReach || HasComp<DiseaseMachineRunningComponent>(uid) || !this.IsPowered(uid, EntityManager) || !HasComp<HandsComponent>(args.User) || HasComp<ToolComponent>(args.Used))
                return;
