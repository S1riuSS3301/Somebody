...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private OptionButton _erpStatus = null!; //AlphaCentauri
        ...
        public void RefreshFlavorText()
        {
            if (_cfgManager.GetCVar(CCVars.FlavorText))
            {
                ...
                _erpStatus.AddItem(Loc.GetString("character-erp-status-no"), (int) EnumStatus.NO);
                _erpStatus.AddItem(Loc.GetString("character-erp-status-half"), (int) EnumStatus.HALF);
                _erpStatus.AddItem(Loc.GetString("character-erp-status-full"), (int) EnumStatus.FULL);
                _erpStatus.OnItemSelected += args =>
                {
                    ...
                    Profile = Profile.WithERPStatus((EnumStatus) args.Id);
                    IsDirty = true;
                };
        ...
        private void UpdateERPStatus()
        {
            if(_erpStatus != null)
            {
                _erpStatus.SelectId((int) (Profile?.ERPStatus ?? EnumStatus.NO));
            }
        }
        // AlphaCentauri-ERPStatus-End
